                ...
                <div className="hero rounded-[24px] overflow-hidden" style={{ backgroundImage: 'url(https://i.ibb.co/g9s6CQC/hero-bg.jpg)' }}>
                    ...
                    <div className="hero-content text-center text-neutral-content">
                        <div className="max-w-[840px] pt-[80px] pb-[80px]">
                            <h1 className="mb-8 text-[32px] leading-10 lg:text-5xl font-bold text-white">Uncover a unique cooking class perfectly customized to suit your tastes and preferences!</h1>
